...
if __name__ == '__main__':
    ...
    for ipu in RunPeriod:
       ...
       # Make_CondorScr("SingleNeutrino_Flat2017",Study,221,221, "./configs/%s/SingleNeutrino_Flat2017.config"%(Study))
            ...
            #Make_CondorScr("SingleNeutrino_PreMix2017",Study, 21, 21, "./configs/%s/SingleNeutrino_PreMix2017.config"%(Study))
            #Make_CondorScr("SingleNeutrino_PreMix2017",Study, 21, 21, "./configs/%s/SingleNeutrino_PreMix2017.config"%(Study))
            if (ipu == "PURunB" or ipu == "PURunC" or ipu == "PURunD" or ipu == "PURunE" or ipu == "PURunF_e"): Make_CondorScr("SingleNeutrino_Flat2016_PreVFP_v2",Study,16,16, "./configs/%s/SingleNeutrino_Flat2016_PreVFP_v2.config"%(Study))
            elif (ipu == "PURunF_l" or ipu == "PURunG" or ipu == "PURunH"): Make_CondorScr("SingleNeutrino_Flat2016_PostVFP_v2",Study,16,16, "./configs/%s/SingleNeutrino_Flat2016_PostVFP_v2.config"%(Study))
            else : 
                Make_CondorScr("SingleNeutrino_Flat2016_PreVFP_v2",Study,16,16, "./configs/%s/SingleNeutrino_Flat2016_PreVFP_v2.config"%(Study))
                Make_CondorScr("SingleNeutrino_Flat2016_PostVFP_v2",Study,16,16, "./configs/%s/SingleNeutrino_Flat2016_PostVFP_v2.config"%(Study))
    print Study
